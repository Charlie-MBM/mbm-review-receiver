#!/usr/bin/env python3
"""Fresh-inode verification copy of nurture_engine.py (T5d). The sandbox mount
caches a truncated view of the overwritten canonical engine; this copy lets the
sandbox import the real logic. Canonical = nurture_engine.py (host)."""
