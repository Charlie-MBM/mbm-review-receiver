...
---------------------
  ...
  REVIEW_BASE_URL      Public URL of this receiver (used to build /review?name= links)
...
REVIEW_BASE_URL = os.environ.get("REVIEW_BASE_URL", "http://localhost:5000")
...
def send_review_email(first_name: str, email: str) -> bool:
    ...
    review_link = f"{REVIEW_BASE_URL}/review?name={name_param}" if name_param else f"{REVIEW_BASE_URL}/review"
